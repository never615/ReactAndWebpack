...
import imageLogo from '../static/image/y18.gif';
import '../static/css/NewsHeader.css'

export default class NewsHeader extends React.Component {
    getLogo() {
        return (
            <div className="newsHeader-logo">
                <a href="http://never615.com"><img src={imageLogo}/></a>
            </div>
        );
    }
    ...
    getTitle() {
        return (
            <div className="newsHeader-title">
                <a className="newsHeader-textLink" href="http://never615.com">Hacker News</a>
            </div>
        );
    }
